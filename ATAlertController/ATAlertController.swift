...
public class ATAlertController {
    ...
    */
    ...
    /**
    Initialize a new ATAlertController
    ...
    */
     ...
     */
	@discardableResult
    public func addAction(_ title: String, style: UIAlertAction.Style, handler: actionHandler? = nil) -> ATAlertController {
    ...
    */
	@discardableResult
    internal func addAction(_ title: String, style: UIAlertAction.Style, preferredAction: Bool = false, handler: actionHandler? = nil) -> ATAlertController {
	...
	@discardableResult
	public func presentIn(_ source: UIViewController) -> ATAlertController {
	...
	@discardableResult
	public func delay(_ time: TimeInterval) -> ATAlertController {
		delayTime = time
		return self
	}
...
///Alert controller
public class Alert: ATAlertController {
    ...
    */
    ...
    public func showOkay() {
        super.addAction("Ok", style: .cancel, preferredAction: false, handler: nil)
        show()
    }
}
...
public class ActionSheet: ATAlertController {
